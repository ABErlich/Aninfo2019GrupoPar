...
export class TicketService extends BaseService {
    ...
    private tarea: Task = { name: 'Boton proyecto', asignee: new Resource(), priority: TaskPriority.LOW, state: TaskState.PENDING, estimatedTime: 5, dedicatedTime: 5, projectId: '', description: 'Arreglar overflow de proyecto' }

    private tickets: Ticket[] = [

        { numeroTicket: 1, clienteCode: "123", tipo: 'Incidente', producto: 'CRM', vProducto: '2.0.5', severidad: 'Alta', estado: 'Abierto', asunto: 'Error en la generacion de un proyecto', descripcion: 'El usuario se posisiona el la solapa de proyecto, presiona el boton nuevo proyecto y se cierra el navegador', responsable: 'Juan Perez', fechaAlta: new Date(), departamento: 'Desarrollo', tareas: [this.tarea] },
