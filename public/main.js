...
/* harmony import */ var src_app_services_resource_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/app/services/resource.service */ "./src/app/services/resource.service.ts");
...
var TicketDetalleComponent = /** @class */ (function () {
    function TicketDetalleComponent(location, route, ticketService, projectService, taskService, resourceService) {
        this.location = location;
        this.route = route;
        this.ticketService = ticketService;
        this.projectService = projectService;
        this.taskService = taskService;
        this.resourceService = resourceService;
        this.displayedColumns = ['nombre', 'asignado', 'estado', 'prioridad', 'hsEstimadas', 'hsDedicadas'];
    ...
    TicketDetalleComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common__WEBPACK_IMPORTED_MODULE_2__["Location"],
            ...
            src_app_services_resource_service__WEBPACK_IMPORTED_MODULE_8__["ResourceService"]])
...
/* harmony import */ var _base_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./base.service */ "./src/app/services/base.service.ts");
/* harmony import */ var rxjs_add_operator_map__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! rxjs/add/operator/map */ "./node_modules/rxjs-compat/_esm5/add/operator/map.js");
/* harmony import */ var _models_Task__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../models/Task */ "./src/app/models/Task.ts");
...
var TicketService = /** @class */ (function (_super) {
    ...
    function TicketService() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.tarea = { name: 'Boton proyecto', asignee: new _models_Resource__WEBPACK_IMPORTED_MODULE_6__["default"](), priority: _models_Task__WEBPACK_IMPORTED_MODULE_5__["TaskPriority"].LOW, state: _models_Task__WEBPACK_IMPORTED_MODULE_5__["TaskState"].PENDING, estimatedTime: 5, dedicatedTime: 5, projectId: '', description: 'Arreglar overflow de proyecto' };
        _this.tickets = [
            { numeroTicket: 1, clienteCode: "123", tipo: 'Incidente', producto: 'CRM', vProducto: '2.0.5', severidad: 'Alta', estado: 'Abierto', asunto: 'Error en la generacion de un proyecto', descripcion: 'El usuario se posisiona el la solapa de proyecto, presiona el boton nuevo proyecto y se cierra el navegador', responsable: 'Juan Perez', fechaAlta: new Date(), departamento: 'Desarrollo', tareas: [_this.tarea] },
