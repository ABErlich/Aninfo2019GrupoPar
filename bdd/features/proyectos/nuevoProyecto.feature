Feature: Crear un proyecto
    ...
    Scenario: Nuevo proyecto sin requerimientos
        Given tengo un proyecto de nombre 'Enterprise Resource Planning', codigo 'ERP', descripcion 'Sistema de planificacion de recursos, expensas, etc.', lider 'Felipe Codeo'
        ...
        And al consultar 'lider' del proyecto vale 'Felipe Codeo'
    
    Scenario: Error al crear un proyecto por faltar nombre
        Given tengo un proyecto de codigo 'ERP', descripcion 'Sistema de planificacion de recursos, expensas, etc.', lider 'Felipe Codeo'
        When creo el proyecto
        Then deberia obtener un error que diga 'Parametro requerido: nombre'

    Scenario: Error al crear un proyecto por faltar codigo
        Given tengo un proyecto de nombre 'Enterprise Resource Planning', descripcion 'Sistema de planificacion de recursos, expensas, etc.', lider 'Felipe Codeo'
        When creo el proyecto
    ...
    Scenario: Error al crear un proyecto por faltar descripcion
        Given tengo un proyecto de nombre 'Enterprise Resource Planning', codigo 'ERP', lider 'Felipe Codeo'
        When creo el proyecto
    ...
    Scenario: Nuevo proyecto con requerimientos
        Given tengo un proyecto de nombre 'Enterprise Resource Planning', codigo 'ERP', descripcion 'Sistema de planificacion de recursos, expensas, etc.', lider 'Felipe Codeo', requerimientos 'Ser portable., Que este conectado con la nube.'
        When creo el proyecto
        Then al consultar 'nombre' del proyecto vale 'Enterprise Resource Planning'
        And al consultar 'codigo' del proyecto vale 'ERP'
        And al consultar 'descripcion' del proyecto vale 'Sistema de planificacion de recursos, expensas, etc.'
